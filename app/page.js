    ...
    <>
      <div className="flex justify-center flex-col gap-4 text-white  items-center h-[44vh] px-5 md:px-0 text-xs md:text-base">
        <div className="font-bold text-xl md:text-4xl flex justify-center items-center gap-3">
          Buy me a coffee
          <span><Image unoptimized width={44} height={44} src="/coffee.gif" alt="" /></span>
        </div>
      ...
      <div className="text-white container mx-auto py-6 px-10 md:px-0">
        ...
        <div className="flex gap-5 justify-around">
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <Image unoptimized className="bg-slate-400 rounded-full p-2 text-black" width={88} height={88} src="/vlogger.gif" alt="" />
          ...
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <Image unoptimized className="bg-slate-400 rounded-full p-2 text-black" width={88} height={88} src="/dollar.gif" alt="" />
            <p className="font-bold text-center">Your Fans want to help</p>
            <p className="text-center">Your fans are awailable for you to help you</p>
          </div>
          <div className="item space-y-3 flex flex-col items-center justify-center">
            <Image unoptimized className="bg-slate-400 rounded-full p-2 text-black" width={88} height={88} src="/team.gif" alt="" />
            <p className="font-bold text-center">Your Fans want to help</p>
            <p className="text-center">Your fans are awailable for you to help you</p>
          </div>
        </div>
