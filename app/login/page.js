...
const Login = () => {
    ...
    useEffect(() => {
        ...
        if (metaDescription) {
            metaDescription.setAttribute("content", "This is the login page")
        }
    }, [])
    ...
    return (
        <>
            <div className='text-white py-6 '>
                <h1 className='font-bold text-2xl text-center'>Login/Signup to Get started</h1>

                <div className="social-login-btn">
                    <div className="flex flex-col gap-2 min-h-screen items-center p-10">


                        <button className="flex items-center border w-72 text-center border-</div>gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                        ...
                        <button className="flex items-center border w-72 text-center border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                            <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
                        ...
                        <button onClick={() => { signIn("github") }} className="flex items-center border w-72 text-center border-gray-300 rounded-lg shadow-md max-w-xs px-6 py-2 text-sm font-medium text-white hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                            <svg className="h-6 w-6 mr-2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
